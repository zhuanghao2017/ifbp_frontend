require([
	...
	'css!apworkbench/css/Myapplist.css',
	'css!apworkbench/css/widgetlist.css',
	'apworkbench/js/widgetlist/WidgetList',
	'dialog',
	'customEvent'
], function  () {
    ...
    ReactDOM.render(<WidgetList/>, document.getElementById("widgetlist"));
