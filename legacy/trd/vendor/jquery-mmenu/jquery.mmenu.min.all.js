      ...
      init: function (e) {
        ...
        l.each(function () {
          ...
          if (!n.children("." + a.navbar).length && !s.hasClass(a.vertical)) {
            if (s.parent().is("." + a.listview))var s = s.closest("." + a.panel); else var r = s.closest("." + a.panel).find('a[href="#' + n.attr("id") + '"]').first(), s = r.closest("." + a.panel);
        ...
        l.$body.on(r.click + "-oncanvas", "a[href]", function (s) {
          ...
          if (r && l && i.is("." + a.listview + " > li > a") && !i.is('[rel="external"]') && !i.is('[target="_blank"]')) {
            n.__valueOrFn(n.opts.onClick.setSelected, i) && n.setSelected(e(s.target).parent());
            var p = n.__valueOrFn( i, "#" == o.slice(0, 1));
            p &&  n.__valueOrFn(n.opts.onClick.close, i, p) && n.close()
          }
        })
...
!function (e) {
  ...
  e[t].addons[o] = {
    ...
    a.$wndw.off(i.keydown + "-" + o).on(i.keydown + "-" + o, function (e) {
      return a.$html.hasClass(n.opened) && 9 == e.keyCode ? ( !1) : void 0
    });
    var e = 0;
...
!function (e) {
  ...
  e[n].addons[i] = {
    setup: function () {
      ...
      if (this.conf[i], d = e[n].glbl, "boolean" == typeof l && (l = {add: l}), "number" == typeof l && (l = {
          add: !0,
          visible: l
...
!function (n) {
  ...
  }, n[a].configuration[t] = {breadcrumbSeparator: "/"}, n[a].configuration.classNames[t] = {
    panelTitle: "Title",
    panelNext: "Next",
    panelPrev: "Prev"
  };
      ...
      r = e[n].glbl, "boolean" == typeof d && (d = {add: d}), "object" != typeof d && (d = {}), d = this.opts[a] = e.extend(!0, {}, e[n].defaults[a], d), this.bind("close", function () {
        ...
        if (d.add) {
          ...
          a.each(function () {
            ...
            if (a)var r = n.closest("." + l.panel), c = r; else var r = e("." + l.panel, o.$menu), c = o.$menu;
