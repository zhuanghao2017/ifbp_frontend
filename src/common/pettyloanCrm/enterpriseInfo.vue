<template>
  <div id="pettyloan-enterprise-info">
    ...
    <div class="detail-container">
      ...
      <div class="content-main">
        ...
        <div class="content-left" style="margin-bottom: 20px">
          <!-- 基本档案开始 -->
          <div class="detail-item" id="enterprise-information" style="height: 240px;">
            <div class="detail-items" style="height:220px;">
  ...
  export default {
    ...
    data(){
      ...
      return {
        ...
        pktemp: {
          'enterprise-information': '87528c62-9a0c-49eb-8f84-853a39518e56', // 企业用户基本信息_小贷
          'deep-information': 'a84e531c-ccce-4ed2-9d46-856d4f26ced9', // 深度信息_小贷
          'contracts-record': '1b0918fa-7560-4b56-9b70-8802e73344fb', // 联系人信息_小贷
          'bank-record-form': '81d691ed-8df2-41ea-8a68-ab4c36f39923', // 企业客户银行账户表单_小贷
          'bank-record':'adf76df8-a4f5-402f-9d70-59cc8963f3c9', // 企业客户银行账户表格_小贷
          'salesman-information': '7103a85c-2ce5-4ca2-806f-5d7f739405fb', // 业务员信息_小贷
    ...
    requestBank() { // 获取银行账户值数据
        ...
        this.handleMultiValidate(['enterprise-information','deep-information']).then(() => {
          ...
          this.$http({
            ...
            if(res.data.success === true) {
              ...
              this.$router.push('/pettyloanCrm/enterpriseInfo/' + this.id);
     ...
     //设置空值
      ...
      scroll() {
        if(this.$route.path.indexOf('/pettyloanCrm/enterpriseInfo') < 0){
          return;
        }
        this.fixedNav();
        this.scrollFocus();
      ...
      // 控制side-nav悬浮在页面右上方
      fixedNav() {
        if($('#pettyloan-enterprise-info .content-main').length > 0) {
          const mainTop = $('#pettyloan-enterprise-info .content-main').offset().top;
          const $fixedDom = $('#pettyloan-enterprise-info .content-right');
          if(mainTop >= 82) {
...
<style>
  #pettyloan-enterprise-info .detail-container .el-form-item {
    margin-bottom: 22px;
  }
  #pettyloan-enterprise-info .detail-container input.el-input__inner {
    height: 28px !important;
  }
  #pettyloan-enterprise-info .detail-container .el-upload__input {
  display: none;
  }
  #pettyloan-enterprise-info .detail-container .el-form-item__label {
    font-size: 13px;
  }
  #pettyloan-enterprise-info .detail-container .save {
    width: 100px;
    margin-left: calc(50% - 50px);
  }
  #pettyloan-enterprise-info .detail-container .group .save {
    width: 100px;
    margin-left: 10px;
    border-radius: 4px;
  }
  #pettyloan-enterprise-info .detail-container .group {
    width: 220px;
    margin-left: calc( 50% - 110px);
    margin-bottom: 20px;
  }
  #pettyloan-enterprise-info .detail-container .el-upload.el-upload--text {
    height: 100%;
    width: 100%;
  }
  #pettyloan-enterprise-info .detail-container .avatar-uploader .el-upload:hover {
    border-color: #20a0ff;
  }
  #pettyloan-enterprise-info .detail-container .avatar-uploader .el-upload {
...
/*  #pettyloan-enterprise-info .detail-container .el-table td.is-left, .el-table th.is-left{
    text-align: center;
  }*/
  #pettyloan-enterprise-info .detail-container .el-table .cell{
    padding-left:10px;
    padding-right:0;
  }
</style>
<style scoped>
  ...
  /*#pettyloan-enterprise-info{
    text-align:center;
  }*/
  #pettyloan-enterprise-info .content-left{
    position:relative;
    width: calc(100% - 175px);
    float: left;
    margin-left:0;
  }
  #pettyloan-enterprise-info .content-right {
    width: 164px;
    float: right;
    position: relative;
  ...
  #pettyloan-enterprise-info .content-right.fixed {
    width: 164px;
    position: fixed;
    right: 20px;
    top: 80px;
