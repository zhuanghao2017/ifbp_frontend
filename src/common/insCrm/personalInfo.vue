...
<div id="insCustomerInfo">
  ...
  <div class="content_main">
    <div class="content_left">
      <div class="content_left_item" id="insCustomerInfoDiv" style="height: 550px;">
      ...
      <div class="content_left_item" id="otherInfo">
          ...
          <!-- <div class="child-title" id="other-info"><b>收支信息</b><i v-if="!createFlags['other-info']" class="el-icon-edit" @click="toggle('other-info')"></i></div> -->
          <div class="child-item">
            <div class="content-left">
              ...
              <!-- <el-button-group  v-if="createFlags['other-info'] && !isCreate" class="button-group">
                <el-button class="save" size="small" type="primary" @click="submit('other-info')" style="width:80px; display:block;">保 存</el-button>
                <el-button class="save" size="small" type="primary" @click="toggle('other-info')" style="width:80px; display:block; margin-left: 20px;">取 消</el-button>
              </el-button-group> -->
            </div>
          </div>
      </div>
...
export default {
  data() {
    ...
    return {
      ...
      pktemp: {
        ...
        'deep-info': '87dbdf3b-f694-4e13-8e14-bc6595872844', // 深度信息
        ...
        'salesman-info': '05755a6f-28cc-44da-8f59-c6d5f2d46af1', // 业务员信息
        customer: '4aebbf99-b40b-47d3-87bb-47b6bb7fc9b4', // 客户信息(右)_保险
        contacts: '35dfcc61-a55f-44b1-9694-d4f7ff207f55', // 关系人信息
        bank: 'ca9ee612-e0cb-42bf-9717-624d3d033904', // 个人客户银行账户表格_保险
        capital: '66a62597-bc64-428e-bf9f-decaed96d4d2',
        'bank-record-form': '7e9181e5-c146-4360-8b2f-c8eb6adc89a7', // 个人客户银行账户表单_保险
      },
      title: '客户信息设置',
  ...
  methods: {
    ...
    scroll() {
      if(this.$route.path.indexOf('/insCrm/personalInfo') < 0){
        return;
      }
      this.fixedNav();
      this.scrollFocus();
    ...
    // 控制side-nav悬浮在页面右上方
    fixedNav() {
      if($('#insCustomerInfo .content_main').length > 0) {
        const mainTop = $('#insCustomerInfo .content_main').offset().top;
        const $fixedDom = $('#insCustomerInfo .nav_right');
        if(mainTop >= 82) {
    ...
    handleBasicRecordButton(eventName, itemName) {
      ...
      this.$router.push('/insCrm/personalDetail/' + this.id);
    },
        ...
        this.handleMultiValidate(['customer',]).then(() => {
          ...
          this.$http({
            ...
            if(res.data.success === true) {
              ...
              this.$router.push('/insCrm/personalInfo/' + this.id);
...
<style>
  ...
  /*#insCustomerInfo .title-header{*/
    /*height: 56px;*/
    /*padding: 10px 20px;*/
    /*background-color: #ffffff;*/
    /*border-bottom: 1px solid #e3e3e3;*/
  /*}*/
  /*#insCustomerInfo .title-header h2 {*/
    /*font-size: 18px;*/
    /*font-weight: bold;*/
  /*}*/
  #insCustomerInfo .search-header {
    height: 50px;
    padding: 5px 20px;
    background-color: #ffffff;
    border-bottom: 1px solid #e3e3e3;
  ...
  #insCustomerInfoDiv.content_left_item {
    padding: 10px;
  }
  ...
  #insCustomerInfo .nav_right.fixed{
    width: 164px;
    position: fixed;
    right: 31px;
    top: 80px;
  ...
  #insCustomerInfo .el-upload__input{
    display: none;
  }
  .idCardUpload__title {
    position: absolute;
  ...
  #insCustomerInfo .idCardInfo_left {
    width: 312px;
    text-align: center;
    margin-left: 13px;
    margin-top: 30px;
  ...
  #insCustomerInfo .idCardInfo_left_photo {
    height: 170px;
    width: 100%;
    /*border-right: 1px solid #CECECE;
    border-bottom: 1px solid #CECECE;*/
  }
  #insCustomerInfo .idCardInfo_left_photo + p{
    height: 30px;
    width: 100%;
    margin: 14px 0;
    line-height: 30px;
  }
  #insCustomerInfo .idCardInfo_right {
    width: calc(100%);
    /* height: 228px; */
    position: relative;
    float: right;
  }
  #insCustomerInfo .idCardInfo_right .customer_template {
    padding: 3px 0;
    margin: 0;
  }
/*  #insCustomerInfo .customer_template .el-form-item {
    margin-bottom: 0px;
  }*/
/*   #insCustomerInfo .el-form-item {
  margin-bottom: 5px;
} */
  #insCustomerInfo .el-form-item__label {
    padding: 11px 12px 11px 0;
    font-size: 15px;
  }
  #insCustomerInfo #deepInfo .el-form-item__content{
    line-height: 36px;
  }
  #insCustomerInfo .el-form-item__content{
    /* line-height: 18px; */
  }
  #insCustomerInfo .el-form-item__label {
  ...
  #insCustomerInfo .el-button-group .el-button:first-child{
    border-radius:4px;
  }
  #insCustomerInfo .el-button-group .el-button:last-child{
    border-radius:4px;
  }
  #insCustomerInfo .idCardInfo {
    font-size: 14px;
  }
  #insCustomerInfo .self_form_row {
    /* height: 30px;
    padding: 15px 0; */
  }
  ...
  #insCustomerInfo #self-grid  {
    margin-bottom: 20px;
    padding: 0 10px;
  }
  #insCustomerInfo input.el-input__inner {
    height: 28px;
  }

  /* upload css */
  #insCustomerInfo .leftTemplate {
    display: inline-block;
    /* float: left; */
    width: calc(100%);
    height: 100%;
  ...
  #insCustomerInfo .content-right {
    position: relative;
  }
  #insCustomerInfo .hoverCard{
    width: 100%;
    height: 125px;
    position: absolute;
    top: 3px;
  ...
  #insCustomerInfo .yon-form div.tpl-label {
    font-size: 14px;
  }
  ...
  #insCustomerInfo .avatar-uploader .el-upload {
    border-radius: 6px;
    cursor: pointer;
    position: relative;
    overflow: hidden;
  }
  #insCustomerInfo .upload-box {
    border: 1px dashed #d9d9d9;
    text-align: center;
  }
  #insCustomerInfo .avatar-uploader .el-upload:hover {
    border-color: #20a0ff;
  }
  #insCustomerInfo .avatar-show-icon, #insCustomerInfo .avatar-uploader .avatar-uploader-icon {
    font-size: 28px;
    color: #8c939d;
    text-align: center;
    width: 28px;
...
/*   ul#side-nav span.line {
  ...
  #insCustomerInfo .el-table .cell:last-child{
    padding-left:13px;
    padding-right:0;
  }
  .editBank{
